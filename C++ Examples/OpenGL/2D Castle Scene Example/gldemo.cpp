...
void init(int argc, char* argv[]) {
	...
	// Load demo texture
	background = fiLoadTexture("Assets\\sky.jpg");
	grass = fiLoadTexture("Assets\\grass.png");
	castle = fiLoadTexture("Assets\\castle.jpeg");
	window = fiLoadTexture("Assets\\window.jpg");
	door = fiLoadTexture("Assets\\door.jpg");
	knight = fiLoadTexture("Assets\\knight.png");
	spear = fiLoadTexture("Assets\\spear.jpg");
	flag = fiLoadTexture("Assets\\flag.png");
	// Shader setup 
